...
def admin_permission_create(request):
    ...
    return render(request, 'admin_panel/permission_create.html', context)
...
def admin_permission_edit(request, permission_id):
    ...
    return render(request, 'admin_panel/permission_edit.html', context)
...
def admin_permission_delete(request, permission_id):
    ...
    return render(request, 'admin_panel/permission_delete.html', context)
...
def admin_role_view(request, role_id):
    ...
    return render(request, 'admin_panel/role_view.html', context)
...
def admin_user_roles(request):
    ...
    return render(request, 'admin_panel/user_roles.html', context)
...
def admin_user_role_assign(request):
    ...
    return render(request, 'admin_panel/user_role_assign.html', context)
...
def admin_user_role_remove(request, user_role_id):
    ...
    return render(request, 'admin_panel/user_role_remove.html', context)
